...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	//send some json we'll send to the auth service
...
func (app *Config) logItemViaRPC(w http.ResponseWriter, payload LogPayload) {
	...
	res := jsonResponse{Error: false, Message: result}

	err = app.writeJSON(w, http.StatusAccepted, res)
	if err != nil {
		return
	}
}
